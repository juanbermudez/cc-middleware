...
<img className="diagram-expandable" data-zoom-disabled="true" data-zoomable="false" src="/images/diagrams/concepts-realtime-sync-0.svg" alt="concepts-realtime-sync-0" style={{ width: '100%', cursor: 'pointer' }} />
