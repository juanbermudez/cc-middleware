...
<img className="diagram-expandable" data-zoom-disabled="true" data-zoomable="false" src="/images/diagrams/concepts-hooks-0.svg" alt="concepts-hooks-0" style={{ width: '100%', cursor: 'pointer' }} />
